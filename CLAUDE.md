...
## What this is
A personal HTML/CSS/JS field guide to the Chinese language and civilization. Static site with a Node build system. Content lives in `content/`, pages are generated by `npm run build`.
...
├── index.html              # fetches data/, renders cards — NEVER hand-edit entry cards
