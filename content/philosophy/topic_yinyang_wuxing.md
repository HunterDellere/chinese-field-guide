...
<div class="shell">
  ...
  <main class="main">
    ...
    <div class="scholar" data-glyph="表">
      ...
      <p>One of the most characteristic features of Five Phases thinking is the construction of elaborate correspondence tables (<strong>五行对应 wǔxíng duìyìng</strong>), in which every phenomenon in the natural and human world is assigned to one of the five phases. The system is a theory of resonance: things assigned to the same phase are believed to influence each other. The sour flavor nourishes the liver because both belong to Wood; green foods support Wood energy; spring is the optimal time for Wood-phase treatments in TCM. The system is a map of sympathetic correspondences across all levels of reality.</p>
    </div>
    ...
    <div class="scholar" data-glyph="医">
      ...
      <p>In traditional Chinese medicine (中医 Zhōngyī), Yin-Yang and the Five Phases are the operating framework of diagnosis and treatment, not background philosophy. The body is understood as a microcosm in which the same forces that govern the seasons and the cosmos govern physiology. Disease is a disruption of dynamic balance: an excess or deficiency in one or more of the five systems, or a breakdown in the generative and controlling relationships between them.</p>
      ...
      <p>The seasonal implications are taken seriously in classical medicine: spring is the time to support the liver system; summer the heart; autumn the lungs; winter the kidneys. Eating sour foods in spring, bitter foods in summer, and salty foods in winter aligns one's physiology with the season's phase — a coherent application of the correspondence logic, not an arbitrary prescription. A practitioner navigating this system in real time is reading the body as a miniature cosmos, adjusting each treatment to the season and the individual's current phase balance.</p>
    </div>
