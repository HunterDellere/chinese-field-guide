...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    <span class="toc-topic">误入歧途</span>
    <span class="toc-topic-en">Straying onto the Wrong Road</span>
    ...
    <ul class="toc-list">
      ...
      <li><a href="#pair">
        <span class="toc-cn">对照</span> The Paired Idiom
        <span class="toc-sub">duìzhào · 迷途知返</span>
      </a></li>
  ...
  <main class="main">
    ...
    <span class="section-anchor" id="pair"></span>
    <div class="section-head"><h2>The Paired Idiom · 对照 duìzhào</h2></div>
