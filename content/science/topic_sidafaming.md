...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    <span class="toc-topic">四大发明</span>
    <span class="toc-topic-en">Four Great Inventions</span>
    ...
    <ul class="toc-list">
      <li><a href="#paper">
        <span class="toc-cn">造纸术</span> Paper
        <span class="toc-sub">zàozhǐ shù · Cai Lun and the reed</span>
      </a></li>
      <li><a href="#printing">
        <span class="toc-cn">印刷术</span> Printing
        <span class="toc-sub">yìnshuā shù · movable type</span>
      </a></li>
      <li><a href="#gunpowder">
        <span class="toc-cn">火药</span> Gunpowder
        <span class="toc-sub">huǒyào · from alchemy to artillery</span>
      </a></li>
      <li><a href="#compass">
        <span class="toc-cn">指南针</span> The Compass
        <span class="toc-sub">zhǐnánzhēn · south-pointing needle</span>
      </a></li>
      <li><a href="#legacy">
        <span class="toc-cn">影响</span> Global Legacy
        <span class="toc-sub">yǐngxiǎng · why they mattered</span>
      </a></li>
    </ul>
  </aside>
  ...
  <main class="main">
    ...
    <span class="section-anchor" id="paper"></span>
      ...
      <div class="scholar" data-glyph="纸">
        ...
        <p>Writing materials before paper in China included oracle bones, bronze vessels, bamboo strips, and silk — all either fragile, heavy, rare, or expensive. The development of paper from plant fibers — bark, hemp, rags, and later bamboo — addressed all these problems simultaneously.</p>
    ...
    <span class="section-anchor" id="printing"></span>
      ...
      <div class="scholar" data-glyph="印">
        ...
        <p>Block printing — carving an entire page of text into a wooden block and pressing it onto paper — developed in China during the Tang dynasty, with the oldest surviving examples from the seventh century. The <em>Diamond Sutra</em>, printed in 868 CE and discovered in the Dunhuang caves, is the oldest dated printed book in the world.</p>
    ...
    <span class="section-anchor" id="gunpowder"></span>
      ...
      <div class="scholar" data-glyph="火">
        ...
        <p>Gunpowder (火药, huǒyào — literally "fire medicine") was discovered during the Tang dynasty by Daoist alchemists searching for an elixir of immortality — the combination of sulfur, charcoal, and saltpeter (potassium nitrate) produced an explosive mixture that was emphatically not the immortality drug they were seeking. By the ninth century CE, military applications had been found: fire arrows, bombs, and eventually early firearms.</p>
    ...
    <span class="section-anchor" id="legacy"></span>
      ...
      <div class="scholar" data-glyph="明">
        ...
        <p>The British sinologist Joseph Needham, who documented Chinese science and technology in his monumental <em>Science and Civilisation in China</em>, posed what has become known as the <strong>李约瑟难题</strong> (Lǐ Yuēsè Nántí, the Needham Question): if China was so far ahead of Europe in technology through the Song dynasty, why did the Scientific Revolution happen in Europe and not China?</p>
