...
pageTitle: '风水 Fengshui Geomancy'
tags:
  - 'science'
  - 'cosmology'
  - 'geography'
...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic-en">Geomancy as Proto-Science</span>
    ...
    <ul class="toc-list">
      ...
      <li><a href="#theory">
        <span class="toc-cn">理论</span> Qi, Landscape, and Site Reading
        <span class="toc-sub">the logic of the system</span>
      </a></li>
      <li><a href="#schools">
        <span class="toc-cn">流派</span> Two Schools
        <span class="toc-sub">Form School vs. Compass School</span>
      </a></li>
      <li><a href="#luopan">
        <span class="toc-cn">罗盘</span> The Luopan Compass
        <span class="toc-sub">instrument of orientation</span>
      </a></li>
      <li><a href="#today">
        <span class="toc-cn">当代</span> Fengshui in Contemporary Architecture
        <span class="toc-sub">Hong Kong skyline and beyond</span>
      </a></li>
      <li><a href="#vocab">
  ...
  <main class="main">
    ...
    <header class="topic-hero">
      ...
      <p class="topic-hero-desc">Before the terms ecology, hydrology, and orientation science existed, the fengshui master was reading the same landscape — just with a different vocabulary.</p>
    </header>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Origins — From Burial Site to Living Space</span>
    ...
    <div class="section-head">
      <span class="sh-cn">气、地形与察地</span>
      <span class="sh-py">qì, dìxíng yǔ chá dì</span>
      <span class="sh-en">Qi, Landscape, and Site Reading</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Two Schools — Form vs. Compass</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <footer class="page-footer">
      <span class="footer-id">Field Notes on Chinese · <span>风水</span> · Science &amp; Medicine</span>
