...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">汉字</span>
    <span class="toc-topic-en">Chinese Characters</span>
    ...
    <ul class="toc-list">
      <li><a href="#what">
        <span class="toc-cn">什么是</span> What Characters Are
        <span class="toc-sub">shénme shì · not an alphabet</span>
      </a></li>
      <li><a href="#liushu">
        <span class="toc-cn">六书</span> Six Categories
        <span class="toc-sub">liùshū · how characters are built</span>
      </a></li>
      <li><a href="#simpTrad">
        <span class="toc-cn">简繁</span> Simplified vs Traditional
        <span class="toc-sub">jiǎn fán · the reform</span>
      </a></li>
      <li><a href="#radicals">
        <span class="toc-cn">部首</span> Radicals
        <span class="toc-sub">bùshǒu · the organizing key</span>
      </a></li>
      <li><a href="#vocab">
        <span class="toc-cn">词汇</span> Key Vocabulary
        <span class="toc-sub">cíhuì · character-learning terms</span>
      </a></li>
    </ul>
  </aside>
  ...
  <main class="main">
    ...
    <div class="section-head">
      ...
      <span class="sh-en">What Chinese Characters Are — Not an Alphabet</span>
    ...
    <span class="section-anchor" id="liushu"></span>
    <div class="section-head">
      <span class="sh-cn">六书</span>
      <span class="sh-py">liùshū</span>
      <span class="sh-en">The Six Categories — How Characters Are Built</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="section-head">
      <span class="sh-cn">简繁</span>
      <span class="sh-py">jiǎn fán</span>
      <span class="sh-en">Simplified vs Traditional — The Reform</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Radicals — The Organizing Key</span>
      <span class="sh-rule"></span>
    </div>

    <div class="pattern">
      <span class="label">高频部首 gāopín bùshǒu · High-Frequency Radicals Every Learner Needs</span>
      <strong>人/亻</strong> rén person · <strong>口</strong> kǒu mouth · <strong>手/扌</strong> shǒu hand · <strong>心/忄</strong> xīn heart · <strong>水/氵</strong> shuǐ water · <strong>火/灬</strong> huǒ fire · <strong>木</strong> mù wood · <strong>土</strong> tǔ earth · <strong>日</strong> rì sun · <strong>月</strong> yuè moon/flesh · <strong>山</strong> shān mountain · <strong>言/讠</strong> yán speech · <strong>女</strong> nǚ woman · <strong>金/钅</strong> jīn metal · <strong>目</strong> mù eye · <strong>足/⻊</strong> zú foot
    </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Key Vocabulary for Character Learning</span>
      <span class="sh-rule"></span>
    </div>

    <div class="adj-wrap">
      <span class="adj"><span class="a-cn">汉字</span><span class="a-py">hànzì</span><span class="a-en">Chinese character</span></span>
      <span class="adj"><span class="a-cn">笔画</span><span class="a-py">bǐhuà</span><span class="a-en">stroke</span></span>
      <span class="adj"><span class="a-cn">笔顺</span><span class="a-py">bǐshùn</span><span class="a-en">stroke order</span></span>
      <span class="adj"><span class="a-cn">部首</span><span class="a-py">bùshǒu</span><span class="a-en">radical</span></span>
      <span class="adj"><span class="a-cn">偏旁</span><span class="a-py">piānpáng</span><span class="a-en">component</span></span>
    ...
    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>汉字 hànzì</span></span>
