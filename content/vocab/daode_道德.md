...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">道德</span>
    <span class="toc-topic-en">Morality &amp; Virtue</span>
    ...
    <ul class="toc-list">
      ...
      <li><a href="#core">
        ...
        <span class="toc-sub">héxīn yòngfǎ · morality in practice</span>
      </a></li>
      <li><a href="#de-standalone">
        <span class="toc-cn">德的用法</span> 德 Standalone
        <span class="toc-sub">dé de yòngfǎ · virtue on its own</span>
      </a></li>
      <li><a href="#patterns">
        <span class="toc-cn">构词</span> 德 in Moral Vocabulary
        <span class="toc-sub">dé zài dàodé cíhuì</span>
      </a></li>
      <li><a href="#chengyu">
  ...
  <main class="main">
    ...
    <span class="section-anchor" id="daode-distinction"></span>
    <div class="section-head">
      <span class="sh-cn">道与德</span>
      <span class="sh-py">dào yǔ dé</span>
      <span class="sh-en">道 and 德 — How They Differ</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">morality; ethics; moral conduct; virtue</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">我们应该树立正确的道德观，做一个有责任感的人。</div>
            <div class="ex-py">Wǒmen yīnggāi shùlì zhèngquè de dàodéguān, zuò yī gè yǒu zérèngǎn de rén.</div>
            <div class="ex-en">We should cultivate a sound moral outlook and be people who take responsibility.</div>
          </div>
          <div class="example">
            <div class="ex-cn">道德标准因文化和时代而异，但诚实和仁爱是普遍认可的。</div>
            <div class="ex-py">Dàodé biāozhǔn yīn wénhuà hé shídài ér yì, dàn chénshí hé rén'ài shì pǔbiàn rènkě de.</div>
            <div class="ex-en">Moral standards vary by culture and era, but honesty and benevolence are universally recognized.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">道德观</span>
          <span class="card-py">dàodéguān</span>
          <span class="card-en">moral outlook; values framework; one's view of what is right and wrong</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Rújiā dàodéguān yǐ "rén" wéi héxīn, qiángdiào rén yǔ rén zhījiān de guānxi yǔ zérèn.</div>
            <div class="ex-en">The Confucian moral outlook takes 仁 (benevolence) as its core, emphasizing the relationships and responsibilities between people.</div>
          </div>
          <div class="example">
            <div class="ex-cn">随着社会变迁，年轻一代的道德观也在悄悄发生变化。</div>
            <div class="ex-py">Suízhe shèhuì biànqiān, niánqīng yīdài de dàodéguān yě zài qiāoqiāo fāshēng biànhuà.</div>
            <div class="ex-en">As society changes, the moral outlook of the younger generation is quietly shifting too.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-adj">
        <div class="card-head">
          <span class="card-cn">不道德</span>
          <span class="card-py">bùdàodé</span>
          <span class="card-en">immoral; unethical; morally wrong</span>
        </div>
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Tā de xíngwéi suīrán héfǎ, dàn zài dàodé shàng shì zhàn bù zhù jiǎo de.</div>
            <div class="ex-en">His conduct may be legal, but morally it cannot stand.</div>
          </div>
          <div class="example">
            <div class="ex-cn">网络上的不道德行为正在损害社会信任。</div>
            <div class="ex-py">Wǎngluò shàng de bùdàodé xíngwéi zhèngzài sǔnhài shèhuì xìnrèn.</div>
            <div class="ex-en">Immoral behavior online is eroding social trust.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">职业道德</span>
          <span class="card-py">zhíyè dàodé</span>
          <span class="card-en">professional ethics; occupational morality; the moral standards specific to a role</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">医生的职业道德要求把患者利益放在首位。</div>
            <div class="ex-py">Yīshēng de zhíyè dàodé yāoqiú bǎ huànzhě lìyì fàng zài shǒuwèi.</div>
            <div class="ex-en">Medical ethics requires that a doctor place the patient's interests first.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他违反了新闻职业道德，捏造了这篇报道。</div>
            <div class="ex-py">Tā wéifǎn le xīnwén zhíyè dàodé, niēzào le zhè piān bàodào.</div>
            <div class="ex-en">He violated journalistic ethics by fabricating this report.</div>
          </div>
          <div class="example">
    ...
    <!-- ── 德 STANDALONE ── -->
    <span class="section-anchor" id="de-standalone"></span>
    <div class="section-head">
      <span class="sh-cn">德的用法</span>
      <span class="sh-py">dé de yòngfǎ</span>
      <span class="sh-en">德 Standalone — Virtue on Its Own</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">德行</span>
          <span class="card-py">déxíng</span>
          <span class="card-en">virtuous conduct; moral behavior; virtue as it shows in action</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">古人重视德行修养，认为一个人的品行比才能更重要。</div>
            <div class="ex-py">Gǔrén zhòngshì déxíng xiūyǎng, rènwéi yī gè rén de pǐnxíng bǐ cáinéng gèng zhòngyào.</div>
            <div class="ex-en">The ancients valued the cultivation of virtuous conduct, holding that a person's moral character matters more than their ability.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">品德</span>
          <span class="card-py">pǐndé</span>
          <span class="card-en">character; moral quality; the overall moral caliber of a person</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">一个人的品德，往往在逆境中才得以真正体现。</div>
            <div class="ex-py">Yī gè rén de pǐndé, wǎngwǎng zài nìjìng zhōng cái déyǐ zhēnzhèng tǐxiàn.</div>
            <div class="ex-en">A person's true character is often only revealed in adversity.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">功德</span>
          <span class="card-py">gōngdé</span>
          <span class="card-en">merit; accumulated virtue from good deeds; karmic credit</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Sìmiào lǐ xìntúmen tōngguò bùshī hé niànjīng lái jīlěi gōngdé.</div>
            <div class="ex-en">At the temple, devotees accumulate merit through charitable giving and sutra recitation.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-adj">
        <div class="card-head">
          <span class="card-cn">缺德</span>
          <span class="card-py">quēdé</span>
          <span class="card-en">lacking virtue; despicable; low; morally shabby</span>
        </div>
        <div class="tags"><span class="tag tag-adj">Adj 形容词 xíngróngcí</span></div>
        <div class="card-def">
    ...
    <div class="section-head">
      ...
      <span class="sh-en">德 in Moral Vocabulary</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="adj-wrap">
      <span class="adj"><span class="a-cn">道</span><span class="a-py">dào</span><span class="a-en">the Way; the right path</span></span>
      <span class="adj"><span class="a-cn">仁</span><span class="a-py">rén</span><span class="a-en">benevolence; humaneness</span></span>
      <span class="adj"><span class="a-cn">义</span><span class="a-py">yì</span><span class="a-en">righteousness; duty</span></span>
      <span class="adj"><span class="a-cn">礼</span><span class="a-py">lǐ</span><span class="a-en">ritual propriety; rites</span></span>
      <span class="adj"><span class="a-cn">智</span><span class="a-py">zhì</span><span class="a-en">wisdom; moral discernment</span></span>
      <span class="adj"><span class="a-cn">信</span><span class="a-py">xìn</span><span class="a-en">trustworthiness; faithfulness</span></span>
      <span class="adj"><span class="a-cn">善</span><span class="a-py">shàn</span><span class="a-en">goodness; to be good at</span></span>
      <span class="adj"><span class="a-cn">良心</span><span class="a-py">liángxīn</span><span class="a-en">conscience; moral sense</span></span>
    ...
    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>道德 dàodé</span></span>
