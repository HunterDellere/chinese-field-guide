...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">神明</span>
    <span class="toc-topic-en">Gods · Divine Intelligence</span>
    ...
    <ul class="toc-list">
      <li><a href="#etymology">
        <span class="toc-cn">字源</span> Etymology &amp; Compound
        <span class="toc-sub">shén + míng · spirit + luminous</span>
      </a></li>
      <li><a href="#folk">
        <span class="toc-cn">民间信仰</span> Folk Religion Usage
        <span class="toc-sub">altars, temples, veneration</span>
      </a></li>
      <li><a href="#classical">
        <span class="toc-cn">古典哲学</span> Classical &amp; Philosophical Register
        <span class="toc-sub">Zhuangzi, Xunzi, Han Confucianism</span>
      </a></li>
      <li><a href="#compounds">
        <span class="toc-cn">相关词</span> Related Compounds
        <span class="toc-sub">shén-family vocabulary</span>
      </a></li>
      <li><a href="#bianxi">
        <span class="toc-cn">辨析</span> Contrast Notes
        <span class="toc-sub">神明 vs. 神灵 vs. 神仙</span>
      </a></li>
    </ul>
  </aside>
  ...
  <main class="main">
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Etymology &amp; Compound Analysis</span>
    ...
    <!-- ── FOLK RELIGION ── -->
    <span class="section-anchor" id="folk"></span>
    <div class="section-head">
      <span class="sh-cn">民间信仰</span>
      <span class="sh-py">mínjiān xìnyǎng</span>
      <span class="sh-en">Folk Religion — The Gods of Altar and Temple</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">gods; deities; divine beings (generic, collective)</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他每天早上都会向神明上香，祈求平安。</div>
            <div class="ex-py">Tā měi tiān zǎoshang dōu huì xiàng shénmíng shàng xiāng, qíqiú píng'ān.</div>
            <div class="ex-en">Every morning he burns incense to the gods and prays for peace.</div>
          </div>
          <div class="example">
            <div class="ex-cn">在台湾，神明的种类非常多，各有不同的职责。</div>
            <div class="ex-py">Zài Táiwān, shénmíng de zhǒnglèi fēicháng duō, gè yǒu bùtóng de zhízé.</div>
            <div class="ex-en">In Taiwan, there are very many kinds of gods, each with different responsibilities.</div>
          </div>
          <div class="example">
            <div class="ex-cn">神明保佑我们一家平平安安。</div>
            <div class="ex-py">Shénmíng bǎoyòu wǒmen yī jiā píng píng ān ān.</div>
            <div class="ex-en">May the gods protect our whole family in peace.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-v">
        <div class="card-head">
          <span class="card-cn">拜神明</span>
          <span class="card-py">bài shénmíng</span>
          <span class="card-en">to venerate the gods; to pay respect at a deity's altar</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">每逢初一、十五，她都会去庙里拜神明。</div>
            <div class="ex-py">Měi féng chūyī, shíwǔ, tā dōu huì qù miào lǐ bài shénmíng.</div>
            <div class="ex-en">On the first and fifteenth of each lunar month, she goes to the temple to venerate the gods.</div>
          </div>
          <div class="example">
            <div class="ex-cn">搬进新家前，他们先拜了神明，求得神灵庇佑。</div>
            <div class="ex-py">Bān jìn xīn jiā qián, tāmen xiān bài le shénmíng, qiú dé shénlíng bìyòu.</div>
            <div class="ex-en">Before moving into the new home, they first venerated the gods and sought the spirits' protection.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-v">
        <div class="card-head">
          <span class="card-cn">请神明</span>
          <span class="card-py">qǐng shénmíng</span>
          <span class="card-en">to invite a deity's presence; to install a divine figure ritually</span>
        </div>
        <div class="tags"><span class="tag tag-v">V phrase 动词短语</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">庙会时，乩童会请神明附身，传达神意。</div>
            <div class="ex-py">Miàohuì shí, jītóng huì qǐng shénmíng fùshēn, chuándá shényì.</div>
            <div class="ex-en">At temple festivals, spirit mediums invite the gods to possess them and convey divine messages.</div>
          </div>
          <div class="example">
            <div class="ex-cn">新庙落成需要举行仪式，将神明正式请入。</div>
            <div class="ex-py">Xīn miào luòchéng xūyào jǔxíng yíshì, jiāng shénmíng zhèngshì qǐng rù.</div>
            <div class="ex-en">When a new temple is completed, a ceremony is held to formally invite the gods in.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他花了不少钱，从老庙请来一尊神明供奉。</div>
            <div class="ex-py">Tā huā le bù shǎo qián, cóng lǎo miào qǐng lái yī zūn shénmíng gòngfèng.</div>
            <div class="ex-en">He spent a fair sum to bring a deity from an old temple to enshrine.</div>
          </div>
        </div>
      </div>
    ...
    <div class="section-head">
      <span class="sh-cn">古典哲学</span>
      <span class="sh-py">gǔdiǎn zhéxué</span>
      <span class="sh-en">Classical &amp; Philosophical Register</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">神明之容</span>
          <span class="card-py">shénmíng zhī róng</span>
          <span class="card-en">the bearing of divine clarity; the sage's luminous presence (literary)</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">庄子所说的"神明之容"，是一种超越技术的自然状态。</div>
            <div class="ex-py">Zhuāngzǐ suǒ shuō de "shénmíng zhī róng", shì yī zhǒng chāoyuè jìshù de zìrán zhuàngtài.</div>
            <div class="ex-en">The "bearing of divine clarity" that Zhuangzi describes is a natural state that transcends technique.</div>
          </div>
          <div class="example">
            <div class="ex-cn">那位老匠人举手投足间，自有一种神明之容。</div>
            <div class="ex-py">Nà wèi lǎo jiàngrén jǔshǒu tóuzú jiān, zì yǒu yī zhǒng shénmíng zhī róng.</div>
            <div class="ex-en">In that old craftsman's every gesture there was a natural bearing of divine clarity.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">神明自得</span>
          <span class="card-py">shénmíng zì dé</span>
          <span class="card-en">divine clarity comes of itself; luminous intelligence arises spontaneously from cultivation</span>
        </div>
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Tā yánxí shūfǎ sānshí nián, xià bǐ shí zhēn yǒu shénmíng zì dé zhī gǎn.</div>
            <div class="ex-en">He has studied calligraphy for thirty years; when the brush comes down, there is truly a sense of clarity arising of itself.</div>
          </div>
        </div>
      </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Related Compounds — The 神 Family</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">spirits; supernatural beings (diffuse, including ghosts and nature spirits)</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">古人相信山川之间充满了各种神灵。</div>
            <div class="ex-py">Gǔrén xiāngxìn shān chuān zhī jiān chōngmǎn le gèzhǒng shénlíng.</div>
            <div class="ex-en">The ancients believed that rivers and mountains were filled with all kinds of spirits.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他祭祀天地神灵，祈求来年风调雨顺。</div>
            <div class="ex-py">Tā jìsì tiāndì shénlíng, qíqiú láinián fēng tiáo yǔ shùn.</div>
            <div class="ex-en">He performed sacrifices to the spirits of heaven and earth, praying for favorable winds and rain in the coming year.</div>
          </div>
          <div class="example">
            <div class="ex-cn">这座古庙供奉的神灵来历不明，但当地人世代都来拜祭。</div>
            <div class="ex-py">Zhè zuò gǔ miào gòngfèng de shénlíng láilì bùmíng, dàn dāngdì rén shìdài dōu lái bàijì.</div>
            <div class="ex-en">The spirit enshrined at this old temple has obscure origins, but local people have come to venerate it for generations.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          <span class="card-cn">神仙</span>
          <span class="card-py">shénxiān</span>
          <span class="card-en">immortals; transcendents (Daoist; deities who achieved divinity through cultivation)</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Dàojiào rènwéi tōngguò xiūliàn kěyǐ chéngwéi shénxiān, dédào fēishēng.</div>
            <div class="ex-en">Daoism holds that through cultivation one can become an immortal, attaining the Dao and ascending.</div>
          </div>
          <div class="example">
            <div class="ex-cn">《西游记》里充满了神仙与妖魔的故事。</div>
            <div class="ex-py">Xī Yóu Jì lǐ chōngmǎn le shénxiān yǔ yāomó de gùshi.</div>
            <div class="ex-en">Journey to the West is full of stories of immortals and demons.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-adj">
        <div class="card-head">
          ...
          <span class="card-en">sacred; holy; inviolable (adjective)</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">婚姻是神圣的，不能轻率对待。</div>
            <div class="ex-py">Hūnyīn shì shénshèng de, bù néng qīngshuài duìdài.</div>
            <div class="ex-en">Marriage is sacred and must not be treated carelessly.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他认为教育是一项神圣的事业。</div>
            <div class="ex-py">Tā rènwéi jiàoyù shì yī xiàng shénshèng de shìyè.</div>
            <div class="ex-en">He regards education as a sacred undertaking.</div>
          </div>
          <div class="example">
            <div class="ex-cn">这片土地对当地人来说具有神圣的意义。</div>
            <div class="ex-py">Zhè piàn tǔdì duì dāngdì rén lái shuō jùyǒu shénshèng de yìyì.</div>
            <div class="ex-en">This land has sacred significance for the local people.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">miraculous; magical; extraordinary (modern secular usage)</span>
        </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">mythology; myth (lit. "god-talk")</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">中国神话中，女娲用泥土捏出了第一批人类。</div>
            <div class="ex-py">Zhōngguó shénhuà zhōng, Nǚwā yòng nítǔ niē chū le dì yī pī rénlèi.</div>
            <div class="ex-en">In Chinese mythology, Nüwa fashioned the first humans from clay.</div>
          </div>
          <div class="example">
            <div class="ex-cn">希腊神话和中国神话都试图解释世界的起源。</div>
            <div class="ex-py">Xīlà shénhuà hé Zhōngguó shénhuà dōu shìtú jiěshì shìjiè de qǐyuán.</div>
            <div class="ex-en">Both Greek and Chinese mythology attempt to explain the origins of the world.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他把这个经济奇迹称为一个神话，认为难以复制。</div>
            <div class="ex-py">Tā bǎ zhège jīngjì qíjì chēngwéi yī gè shénhuà, rènwéi nán yǐ fùzhì.</div>
            <div class="ex-en">He called this economic miracle a myth, believing it would be hard to replicate.</div>
          </div>
        </div>
      </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Contrast Notes — 神明, 神灵, 神仙</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <!-- ── ADJACENT VOCAB ── -->
    <div class="adj-wrap">
      <span class="adj" data-relation="derived"><span class="a-cn">神</span><span class="a-py">shén</span><span class="a-en">spirit; deity; divine; numinous</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">明</span><span class="a-py">míng</span><span class="a-en">bright; luminous; clear; to understand</span></span>
      <span class="adj" data-relation="contrast" data-distinct="神灵 is broader — any spirit; 神明 implies recognized divine status"><span class="a-cn">神灵</span><span class="a-py">shénlíng</span><span class="a-en">spirits; supernatural beings</span></span>
      <span class="adj" data-relation="contrast" data-distinct="神仙 are Daoist immortals who earned divinity through cultivation; 神明 are gods by nature or community recognition"><span class="a-cn">神仙</span><span class="a-py">shénxiān</span><span class="a-en">immortals; transcendents (Daoist)</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">神圣</span><span class="a-py">shénshèng</span><span class="a-en">sacred; holy (adjective)</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">神奇</span><span class="a-py">shénqí</span><span class="a-en">miraculous; extraordinary</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">神话</span><span class="a-py">shénhuà</span><span class="a-en">mythology</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">菩萨</span><span class="a-py">púsà</span><span class="a-en">bodhisattva (Buddhist)</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">土地公</span><span class="a-py">tǔdìgōng</span><span class="a-en">earth god; local tutelary deity</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">关帝</span><span class="a-py">guāndì</span><span class="a-en">Guan Yu deified; god of war and commerce</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">妈祖</span><span class="a-py">māzǔ</span><span class="a-en">Mazu; goddess of the sea</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">观音</span><span class="a-py">guānyīn</span><span class="a-en">Guanyin; bodhisattva of compassion</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">祭祀</span><span class="a-py">jìsì</span><span class="a-en">sacrifice; ritual offering</span></span>
      ...
      <span class="adj" data-relation="collocation"><span class="a-cn">天</span><span class="a-py">tiān</span><span class="a-en">heaven; sky; the cosmic order</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">道</span><span class="a-py">dào</span><span class="a-en">the Way; the Dao</span></span>
      <span class="adj" data-relation="contrast" data-distinct="鬼 are the spirits of the dead without settled divine status; not 神明"><span class="a-cn">鬼</span><span class="a-py">guǐ</span><span class="a-en">ghost; spirit of the dead</span></span>
    </div>

    <!-- RETENTION SCHOLAR BOX -->
    <div class="scholar" data-glyph="神" style="margin-top:2.5rem;">
      <div class="scholar-label">记忆法 jìyìfǎ · Master Retention Image</div>
      <p>The oracle bone lightning bolt in 神 and the paired sun-and-moon of 明 together produce a theological position: the divine is defined by clarity, not by power. This is not a trivial claim. In traditions where gods are principally characterized by arbitrary will or incomprehensible force, the divine and the intelligible are fundamentally separate. 神明 insists they are the same thing.</p>
      <p>At the home altar, 神明 is a practical category: any deity whose image or tablet is placed there, regardless of origin in Daoist, Buddhist, or folk tradition. In the Zhuangzi and Xunzi, 神明 is the quality of mind that sustained cultivation produces. Both usages circle back to 明: the gods see clearly; the sage, through long effort, begins to see as they do.</p>
      <p>The classical formula from Xunzi earns its own memorization: 积善成德，而神明自得. Accumulate goodness until virtue forms, and divine clarity will come of itself. The sage does not grasp 神明; it arrives when the conditions are right.</p>
    </div>

    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>神明 shénmíng</span> · shenming_神明.html</span>
