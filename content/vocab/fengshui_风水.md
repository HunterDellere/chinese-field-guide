...
metaDesc: "风水 fēngshuǐ: wind and water, the art of siting, and the Chinese science of harmonizing human space with the flows of the natural world."
pageTitle: '风水 fēngshuǐ'
tags:
  - 'cosmology'
  - 'geomancy'
  - 'space'
...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">风水</span>
    <span class="toc-topic-en">Wind and Water</span>
    ...
    <ul class="toc-list">
      ...
      <li><a href="#siting">
        <span class="toc-cn">风水</span> The Art of Siting
        <span class="toc-sub">fēngshuǐ · 堪舆 kānyú</span>
      </a></li>
      <li><a href="#wind">
        <span class="toc-cn">风</span> Wind in Compounds
        <span class="toc-sub">fēng · style, custom, rumor</span>
      </a></li>
      <li><a href="#water">
        <span class="toc-cn">水</span> Water in Compounds
        <span class="toc-sub">shuǐ · level, ink, flow</span>
      </a></li>
      <li><a href="#celestial">
        <span class="toc-cn">四灵</span> The Four Celestial Animals
        <span class="toc-sub">sì líng · directional guardians</span>
      </a></li>
      <li><a href="#chengyu">
  ...
  <main class="main">
    ...
    <!-- ── THE ART OF SITING ── -->
    <span class="section-anchor" id="siting"></span>
    <div class="section-head">
      <span class="sh-cn">风水</span>
      <span class="sh-py">fēngshuǐ</span>
      <span class="sh-en">The Art of Siting</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">feng shui; the art of siting; geomancy</span>
        </div>
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Tāmen qǐng le fēngshuǐ xiānsheng lái kàn kàn xīn bàngōngshì de bùjú.</div>
            <div class="ex-en">They invited a feng shui master to assess the layout of their new office.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">a feng shui treasure land; an auspiciously sited place</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Tāmen bǎ zǔfén qiān dào le fēngshuǐ bǎodì, xīwàng néng gěi hòudài dàilái hǎoyùn.</div>
            <div class="ex-en">They moved the ancestral graves to a feng shui treasure site, hoping it would bring good fortune to their descendants.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">feng shui rotates in turns — fortunes change; the wheel of luck keeps turning</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
    ...
    <!-- ── 风 IN COMPOUNDS ── -->
    <span class="section-anchor" id="wind"></span>
    <div class="section-head">
      <span class="sh-cn">风</span>
      <span class="sh-py">fēng</span>
      <span class="sh-en">风 in Compounds</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">style; manner; character; the distinctive way something is done</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Zhè jiā cāntīng de zhuāngxiū fēnggé shì xīn zhōngshì.</div>
            <div class="ex-en">The décor style of this restaurant is neo-Chinese.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">scenery; landscape; a scenic view</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">customs; folk practices; local mores and traditions</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Chūnjié de fēngsú xíguàn bāokuò tiē chūnlián, fàng biānpào, bàinián.</div>
            <div class="ex-en">Spring Festival customs include posting couplets, setting off firecrackers, and paying New Year visits.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">wind-words wind-language — whispers; rumors; idle gossip</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          ...
          <div class="example">
            ...
            <div class="ex-py">Bèihòu shuō rén de fēngyán fēngyǔ, hài le hěn duō rén.</div>
            <div class="ex-en">Rumors and whispers said behind people's backs have harmed many people.</div>
          </div>
        </div>
      </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">水 in Compounds</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">level; standard; horizontal; one's degree of proficiency</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他的中文水平已经达到了高级。</div>
            <div class="ex-py">Tā de Zhōngwén shuǐpíng yǐjīng dádào le gāojí.</div>
            <div class="ex-en">His Chinese proficiency has already reached an advanced level.</div>
          </div>
          <div class="example">
            <div class="ex-cn">这个地区的生活水平提高了很多。</div>
            <div class="ex-py">Zhège dìqū de shēnghuó shuǐpíng tígāo le hěn duō.</div>
            <div class="ex-en">The standard of living in this region has improved a great deal.</div>
          </div>
          <div class="example">
            <div class="ex-cn">他的厨艺水平让所有人都叹服。</div>
            <div class="ex-py">Tā de chúyì shuǐpíng ràng suǒyǒu rén dōu tànfú.</div>
            <div class="ex-en">His culinary skill level left everyone in admiration.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">ink wash; water-and-ink; the classical Chinese painting medium</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">这幅水墨画寥寥数笔，却意境深远。</div>
            <div class="ex-py">Zhè fú shuǐmò huà liáoliáo shù bǐ, què yìjìng shēnyuǎn.</div>
            <div class="ex-en">This ink wash painting uses only a few strokes, yet its artistic conception is profound.</div>
          </div>
          <div class="example">
            <div class="ex-cn">水墨风格的动画片《大鱼海棠》深受好评。</div>
            <div class="ex-py">Shuǐmò fēnggé de dònghuà piàn "Dà Yú Hǎitáng" shēn shòu hǎopíng.</div>
            <div class="ex-en">The ink-wash style animated film "Big Fish &amp; Begonia" received widespread acclaim.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-n">
        <div class="card-head">
          ...
          <span class="card-en">wind and water mutually generate — the core principle of feng shui energy management</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词 míngcí</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">风水学的核心是气乘风则散，界水则止。</div>
            <div class="ex-py">Fēngshuǐ xué de héxīn shì qì chéng fēng zé sàn, jiè shuǐ zé zhǐ.</div>
            <div class="ex-en">The core of feng shui theory is: "qi rides wind and scatters; it stops at the boundary of water."</div>
          </div>
          <div class="example">
            <div class="ex-cn">藏风聚气是风水学追求的理想状态。</div>
            <div class="ex-py">Cáng fēng jù qì shì fēngshuǐ xué zhuīqiú de lǐxiǎng zhuàngtài.</div>
            <div class="ex-en">Sheltering wind and gathering qi is the ideal state that feng shui seeks to achieve.</div>
          </div>
        </div>
      </div>
    ...
    <span class="section-anchor" id="celestial"></span>
    <div class="section-head">
      <span class="sh-cn">四灵</span>
      <span class="sh-py">sì líng</span>
      <span class="sh-en">The Four Celestial Animals</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="table-wrap">
      <table>
        ...
        <tbody>
          <tr>
            <td>Azure Dragon</td>
            <td class="td-cn">青龙 qīng lóng</td>
            <td>East</td>
            <td>Wood 木</td>
            <td>Spring</td>
            <td>Blue-green</td>
          ...
          <tr>
            <td>Vermilion Bird</td>
            <td class="td-cn">朱雀 zhū què</td>
            <td>South</td>
            <td>Fire 火</td>
            <td>Summer</td>
            <td>Red</td>
          ...
          <tr>
            <td>Black Tortoise</td>
            <td class="td-cn">玄武 xuán wǔ</td>
            <td>North</td>
            <td>Water 水</td>
            <td>Winter</td>
            <td>Black</td>
    ...
    <div class="adj-wrap">
      <span class="adj"><span class="a-cn">堪舆</span><span class="a-py">kānyú</span><span class="a-en">geomancy; classical term</span></span>
      <span class="adj"><span class="a-cn">气</span><span class="a-py">qì</span><span class="a-en">vital energy; qi</span></span>
      <span class="adj"><span class="a-cn">龙脉</span><span class="a-py">lóngmài</span><span class="a-en">dragon veins; mountain ridgelines</span></span>
      <span class="adj"><span class="a-cn">方位</span><span class="a-py">fāngwèi</span><span class="a-en">cardinal orientation; direction</span></span>
      <span class="adj"><span class="a-cn">朝向</span><span class="a-py">cháoxiàng</span><span class="a-en">facing direction</span></span>
      <span class="adj"><span class="a-cn">阴宅</span><span class="a-py">yīnzhái</span><span class="a-en">yin dwelling = tomb</span></span>
      <span class="adj"><span class="a-cn">阳宅</span><span class="a-py">yángzhái</span><span class="a-en">yang dwelling = home for the living</span></span>
      <span class="adj"><span class="a-cn">吉祥</span><span class="a-py">jíxiáng</span><span class="a-en">auspicious</span></span>
      <span class="adj"><span class="a-cn">煞气</span><span class="a-py">shāqì</span><span class="a-en">malevolent energy</span></span>
