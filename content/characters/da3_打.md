...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    <span class="toc-glyph">打</span>
    <span class="toc-pinyin">dǎ · tone 3</span>
    <div class="toc-divider"></div>
    <span class="toc-label">On this page</span>
    <ul class="toc-list">
      <li><a href="#etymology"><span class="toc-cn">字源</span> Etymology<span class="toc-sub">hand + a strike</span></a></li>
      <li><a href="#lighverb"><span class="toc-cn">轻动词</span> 打 as Light Verb<span class="toc-sub">make, do, play</span></a></li>
      <li><a href="#sports"><span class="toc-cn">运动</span> Sports &amp; Activities<span class="toc-sub">打球 · 打牌 · 打太极</span></a></li>
      <li><a href="#practical"><span class="toc-cn">实用</span> Practical Uses<span class="toc-sub">calls, injections, knots</span></a></li>
  ...
  <main class="main">
      ...
      <div class="hero-inner">
        <div class="hero-glyph-col">
          <div class="hero-script-pair">
            <div class="hero-script hero-script--simp"><span class="hero-glyph">打</span><span class="hero-script-label">simplified</span></div>
            <div class="hero-script-divider"></div>
            <div class="hero-script hero-script--trad"><span class="hero-glyph">打</span><span class="hero-script-label">traditional · same</span></div>
          </div>
        </div>
        <div class="hero-meta">
          <div class="hero-pinyin">dǎ</div>
          <div class="hero-en">to hit · to strike · to make · to play · to do · to pack · to tie</div>
          <div class="hero-chips">
            <span class="chip">部首 bùshǒu · 扌shǒu hand</span>
            <span class="chip">5 笔画 bǐhuà strokes</span>
            <span class="chip chip-hsk">HSK 1</span>
            <span class="chip">tone 3 · dǎ</span>
          </div>
        </div>
      </div>
    </header>
    ...
    <div class="scholar" data-glyph="打">
      ...
      <p>The original meaning was narrow: to hit with the hand, to strike. But 打 expanded through spoken Chinese into a generalized <strong>light verb</strong> — a semantically bleached action word that combines with nouns to form compound expressions. This is the pattern of 打 that makes it one of the most important verbs to learn: not the hitting, but the doing, making, playing, and handling.</p>
    </div>

    <span class="section-anchor" id="lighverb"></span>
    ...
    <div class="section-head"><span class="sh-cn">运动与活动</span><span class="sh-py">yùndòng yǔ huódòng</span><span class="sh-en">Sports &amp; Activities — 打 for Things You Play</span><span class="sh-rule"></span></div>

    <div class="cards">

      <div class="card c-v">
        <div class="card-head"><span class="card-cn">打 + sport/game</span><span class="card-py">dǎ + activity</span><span class="card-en">to play (hand-involved sports and games)</span></div>
        <div class="tags"><span class="tag tag-v">V 动词 dòngcí</span></div>
        <div class="card-def">打 is used for sports and activities that involve hand action, hitting, or wielding: 打篮球 (play basketball), 打网球 (play tennis), 打乒乓球 (play table tennis), 打太极 (practice tai chi), 打牌 (play cards), 打麻将 (play mahjong), 打游戏 (play video games). Contrast with 踢 tī (kick) for football: 踢足球, not *打足球.</div>
        <div class="examples">
          <div class="example"><div class="ex-cn">他每天早上去公园打太极。</div><div class="ex-py">Tā měi tiān zǎoshang qù gōngyuán dǎ tàijí.</div><div class="ex-en">He goes to the park every morning to practice tai chi.</div></div>
          <div class="example"><div class="ex-cn">周末我们去打篮球吧！</div><div class="ex-py">Zhōumò wǒmen qù dǎ lánqiú ba!</div><div class="ex-en">Let's go play basketball this weekend!</div></div>
        </div>
      </div>

    </div>

    <span class="section-anchor" id="practical"></span>
    <div class="section-head"><span class="sh-cn">实用打语</span><span class="sh-py">shíyòng dǎ yǔ</span><span class="sh-en">Practical 打 — Calls, Injections, Discounts</span><span class="sh-rule"></span></div>

    <div class="table-wrap">
      <table>
        <thead><tr><th>词组 Phrase</th><th>拼音 Pīnyīn</th><th>英文 Yīngwén</th></tr></thead>
        <tbody>
          <tr><td class="td-cn">打电话</td><td class="td-py">dǎ diànhuà</td><td>to make a phone call</td></tr>
          <tr><td class="td-cn">打针</td><td class="td-py">dǎ zhēn</td><td>to give/get an injection; to get a shot</td></tr>
          <tr><td class="td-cn">打包</td><td class="td-py">dǎ bāo</td><td>to pack up; to take food to-go (doggy bag)</td></tr>
          <tr><td class="td-cn">打折</td><td class="td-py">dǎ zhé</td><td>to give/get a discount</td></tr>
          <tr><td class="td-cn">打招呼</td><td class="td-py">dǎ zhāohu</td><td>to greet; to say hello</td></tr>
          <tr><td class="td-cn">打扫</td><td class="td-py">dǎsǎo</td><td>to clean; to sweep (a room)</td></tr>
          <tr><td class="td-cn">打扰</td><td class="td-py">dǎrǎo</td><td>to disturb; to bother; sorry to interrupt</td></tr>
          <tr><td class="td-cn">打算</td><td class="td-py">dǎsuàn</td><td>to plan; to intend to</td></tr>
          <tr><td class="td-cn">打交道</td><td class="td-py">dǎ jiāodào</td><td>to deal with; to have dealings with</td></tr>
          <tr><td class="td-cn">打工</td><td class="td-py">dǎgōng</td><td>to work (casual labor); to do odd jobs</td></tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="adj-wrap">
      <span class="adj"><span class="a-cn">打电话</span><span class="a-py">dǎ diànhuà</span><span class="a-en">to make a phone call</span></span>
      <span class="adj"><span class="a-cn">打算</span><span class="a-py">dǎsuàn</span><span class="a-en">to plan; to intend</span></span>
      <span class="adj"><span class="a-cn">打扫</span><span class="a-py">dǎsǎo</span><span class="a-en">to clean; to sweep</span></span>
      <span class="adj"><span class="a-cn">打折</span><span class="a-py">dǎ zhé</span><span class="a-en">to give a discount</span></span>
    ...
    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>打 dǎ</span></span>
