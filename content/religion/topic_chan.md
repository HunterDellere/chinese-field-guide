...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <ul class="toc-list">
      <li><a href="#origins">
        ...
        <span class="toc-sub">Bodhidharma and the lineage</span>
      </a></li>
      <li><a href="#dunwu">
        <span class="toc-cn">顿悟</span> Sudden Enlightenment
        <span class="toc-sub">Huineng vs. Shenxiu</span>
      </a></li>
      <li><a href="#xiuxing">
        <span class="toc-cn">修行</span> Chan Practices
        <span class="toc-sub">sitting, kōans, daily life</span>
      </a></li>
      <li><a href="#yuyan">
        <span class="toc-cn">禅语</span> Chan Language
        <span class="toc-sub">the indirect style</span>
      </a></li>
      <li><a href="#zushi">
        <span class="toc-cn">祖师</span> The Patriarchs
        <span class="toc-sub">the six transmissions</span>
      </a></li>
      <li><a href="#yingxiang">
        <span class="toc-cn">影响</span> Influence
        <span class="toc-sub">Zen, poetry, painting, tea</span>
      </a></li>
      <li><a href="#chengyu">
        <span class="toc-cn">成语</span> Idioms
        <span class="toc-sub">Chan set phrases</span>
      </a></li>
    </ul>
  </aside>
  ...
  <main class="main">
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Founding Legend and Historical Origins</span>
    ...
    <div class="scholar" data-glyph="禅">
      ...
      <p>This founding story encodes the Chan stance on received religion: sponsoring buildings and copying texts generates no merit because merit is not something accumulated externally. The "I don't know" response is not modesty but the direct pointing to a mind that cannot be grasped conceptually. Wall-gazing for nine years is not biography but a teaching on the inexhaustibility of meditation.</p>
    ...
    <span class="section-anchor" id="dunwu"></span>
    <div class="section-head">
      <span class="sh-cn">顿悟</span>
      <span class="sh-py">dùnwù</span>
      <span class="sh-en">Sudden Enlightenment — The Two Poems on the Wall</span>
      <span class="sh-rule"></span>
    </div>

    <div class="scholar" data-glyph="悟">
    ...
    <!-- ── CHAN PRACTICES ── -->
    <span class="section-anchor" id="xiuxing"></span>
    <div class="section-head">
      <span class="sh-cn">禅宗修行</span>
      <span class="sh-py">chán zōng xiūxíng</span>
      <span class="sh-en">Chan Practices</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <!-- ── CHAN LANGUAGE ── -->
    <span class="section-anchor" id="yuyan"></span>
    <div class="section-head">
      <span class="sh-cn">禅语</span>
      <span class="sh-py">chányǔ</span>
      <span class="sh-en">The Language of Chan — Indirect, Paradoxical, Alive</span>
      <span class="sh-rule"></span>
    </div>

    <div class="scholar" data-glyph="语">
      <div class="scholar-label">语言洞见 yǔyán dòngjiàn · Language Insight</div>
      <p>Chan developed a distinctive literary and rhetorical style — sometimes called 禅语 chányǔ (Chan-speak) — characterized by indirection, paradox, non-sequitur, and the refusal to state things plainly. This is not obscurantism for its own sake but a principled response to the Chan doctrine that conceptual language always falsifies living experience. Words about the moon are not the moon; a map is not the territory; the finger pointing at Buddha is not Buddha.</p>
    ...
    <div class="cards">
      ...
      <div class="card c-neutral">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">僧问："如何是佛？" 师曰："麻三斤。"</div>
            <div class="ex-py">Sēng wèn: "Rúhé shì fó?" Shī yuē: "Má sān jīn."</div>
            <div class="ex-en">A monk asked: "What is Buddha?" The master said: "Three pounds of flax." <em>(Master Dongshan Shouchu)</em></div>
          </div>
        </div>
      </div>
    ...
    </div><!-- /cards chan language -->

    <!-- ── PATRIARCHS ── -->
    <span class="section-anchor" id="zushi"></span>
    <div class="section-head">
      <span class="sh-cn">禅宗祖师</span>
      <span class="sh-py">chán zōng zǔshī</span>
      <span class="sh-en">The Six Patriarchs — The Robe and Bowl Transmission</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-neutral">
        <div class="card-head">
          ...
          <span class="card-en">Bodhidharma — first patriarch; the "wall-gazing Brahmin"</span>
        </div>
        <div class="card-def">
          The semi-legendary Indian founder. His defining image: nine years of wall-gazing at Shaolin, his arms falling off from holding them up in meditation (hence the armless Daruma dolls in Japan). He is said to have brought the Laṅkāvatāra Sutra and to have transmitted a "special transmission outside the scriptures." His first Chinese disciple Huike 慧可 cut off his own arm in the snow to demonstrate sincerity, whereupon Bodhidharma asked: "What troubles you?" Huike replied: "I cannot find peace of mind." Bodhidharma: "Bring me your mind and I will pacify it." Huike: "I have searched for it and cannot find it." Bodhidharma: "I have just pacified it for you."
        </div>
      </div>
    ...
    </div><!-- /cards patriarchs -->

    <!-- ── INFLUENCE ── -->
    <span class="section-anchor" id="yingxiang"></span>
    <div class="section-head">
      <span class="sh-cn">禅的影响</span>
      <span class="sh-py">chán de yǐngxiǎng</span>
      <span class="sh-en">Chan's Influence — Japan, Poetry, Painting, Tea</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Chan Idioms</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="chengyu-grid">
      ...
      <div class="cy">
        <span class="cy-cn">以心传心</span>
        <span class="cy-py">yǐ xīn chuán xīn</span>
        <span class="cy-en">mind transmitted by mind — the direct transmission of awakening from master to student</span>
        <span class="cy-note">The second Chan axiom, paired with 不立文字. Awakening cannot be transferred via words or rituals — only by a direct, living encounter between an awakened mind and a genuinely seeking student. The transmission is often catalyzed by a specific moment: a shout, a blow, a question answered at the right instant. In modern Chinese, 以心传心 is used for any deep mutual understanding that transcends explicit communication.</span>
      </div>

      <div class="cy">
        <span class="cy-cn">拈花微笑</span>
        <span class="cy-py">niān huā wēixiào</span>
        <span class="cy-en">holding up a flower and smiling — the origin story of mind-to-mind transmission</span>
        <span class="cy-note">The foundational Chan transmission story: the Buddha gathered his disciples, held up a flower, and said nothing. All were puzzled — except Mahākāśyapa 摩诃迦叶, who smiled. The Buddha said: "I possess the treasury of the true Dharma eye — I have just transmitted it to Mahākāśyapa." This story (likely Chinese in origin rather than Indian) encodes the entire Chan theory of direct, non-verbal transmission. Used today: a wordless gesture of recognition between two people who understand each other perfectly.</span>
      </div>

      <div class="cy">
        <span class="cy-cn">花开见佛</span>
        <span class="cy-py">huā kāi jiàn fó</span>
        <span class="cy-en">when the flower blooms, the Buddha is seen — sudden illumination after patient waiting</span>
        <span class="cy-note">Originally a Pure Land image (the lotus flower opening in the Pure Land to reveal the practitioner reborn there, seeing Amitābha), adopted by Chan as a metaphor for sudden enlightenment: the moment when all the conditions are right and understanding blooms. Used in modern Chinese for any situation where patient effort or waiting is suddenly rewarded with clear understanding. The same phrase is shared by both Chan and Pure Land traditions, illustrating their deep interpenetration.</span>
      </div>

    </div>

    <div class="adj-wrap">
      <span class="adj"><span class="a-cn">坐禅</span><span class="a-py">zuòchán</span><span class="a-en">sitting meditation</span></span>
      <span class="adj"><span class="a-cn">顿悟</span><span class="a-py">dùnwù</span><span class="a-en">sudden enlightenment</span></span>
      <span class="adj"><span class="a-cn">渐悟</span><span class="a-py">jiànwù</span><span class="a-en">gradual enlightenment</span></span>
      <span class="adj"><span class="a-cn">佛性</span><span class="a-py">fóxìng</span><span class="a-en">Buddha nature</span></span>
      <span class="adj"><span class="a-cn">本来面目</span><span class="a-py">běnlái miànmù</span><span class="a-en">original face</span></span>
      <span class="adj"><span class="a-cn">无</span><span class="a-py">wú</span><span class="a-en">no; nothingness (the Zhaozhou kōan)</span></span>
      <span class="adj"><span class="a-cn">寒山</span><span class="a-py">Hánshān</span><span class="a-en">Cold Mountain (Tang Chan poet)</span></span>
      <span class="adj"><span class="a-cn">语录</span><span class="a-py">yǔlù</span><span class="a-en">recorded sayings of Chan masters</span></span>
      <span class="adj"><span class="a-cn">衣钵</span><span class="a-py">yībō</span><span class="a-en">robe and bowl (transmission)</span></span>
