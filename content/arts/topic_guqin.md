...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">古琴</span>
    <span class="toc-topic-en">The Guqin Zither</span>
    ...
    <ul class="toc-list">
      <li><a href="#instrument">
        <span class="toc-cn">乐器</span> The Instrument
        <span class="toc-sub">seven strings, Zhou dynasty origins</span>
      </a></li>
      <li><a href="#wenren">
        <span class="toc-cn">文人琴</span> The Scholar's Instrument
        <span class="toc-sub">Confucius and the four arts</span>
      </a></li>
      <li><a href="#boyu">
        <span class="toc-cn">伯牙绝弦</span> Breaking the Strings
        <span class="toc-sub">the origin of 知音</span>
      </a></li>
      <li><a href="#notation">
        <span class="toc-cn">减字谱</span> Tablature Notation
        <span class="toc-sub">technique and tonal registers</span>
      </a></li>
      <li><a href="#cihui">
        <span class="toc-cn">词汇</span> Vocabulary
        <span class="toc-sub">key terms in this field</span>
      </a></li>
      <li><a href="#chengyu">
        <span class="toc-cn">成语</span> Idioms
        <span class="toc-sub">guqin set phrases</span>
      </a></li>
    </ul>
  </aside>
  ...
  <main class="main">
    ...
    <!-- ── THE INSTRUMENT ── -->
    <span class="section-anchor" id="instrument"></span>
    <div class="section-head">
      <span class="sh-cn">乐器</span>
      <span class="sh-py">yuèqì</span>
      <span class="sh-en">The Instrument — Seven Strings, Three Thousand Years</span>
    ...
    <span class="section-anchor" id="wenren"></span>
    <div class="section-head">
      <span class="sh-cn">文人琴</span>
      <span class="sh-py">wénrén qín</span>
      <span class="sh-en">The Scholar's Instrument — Confucius and the Four Arts</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <span class="section-anchor" id="boyu"></span>
    <div class="section-head">
      <span class="sh-cn">伯牙绝弦</span>
      <span class="sh-py">Bó Yá jué xián</span>
      <span class="sh-en">Boya Breaks His Strings — The Origin of 知音</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <!-- ── NOTATION ── -->
    <span class="section-anchor" id="notation"></span>
    <div class="section-head">
      <span class="sh-cn">减字谱与音色</span>
      <span class="sh-py">jiǎnzìpǔ yǔ yīnsè</span>
      <span class="sh-en">Tablature Notation and Tonal Registers</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Key Terms in the Guqin Tradition</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-ochre">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">人生得一知音足矣。</div>
            <div class="ex-py">Rénshēng dé yī zhīyīn zú yǐ.</div>
            <div class="ex-en">To find one true 知音 in a lifetime is enough.</div>
          </div>
          <div class="example">
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">琴棋书画</span>
          <span class="card-py">qín qí shū huà</span>
          <span class="card-en">the four scholarly arts — qin, chess, calligraphy, painting</span>
        </div>
        <div class="card-def">
          The canonical curriculum of the 文人 wénrén (literati) tradition. 琴 qín (guqin), 棋 qí (weiqi / go), 书 shū (calligraphy), 画 huà (painting). Proficiency in all four was the mark of an educated person. The order is not alphabetical or arbitrary: the guqin comes first because it was understood to cultivate character directly, through the body and through time.
        </div>
        <div class="examples">
          <div class="example">
            <div class="ex-cn">古代文人须精通琴棋书画。</div>
            <div class="ex-py">Gǔdài wénrén xū jīngtōng qín qí shū huà.</div>
            <div class="ex-en">The scholars of antiquity were expected to be proficient in the four arts.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">减字谱</span>
          <span class="card-py">jiǎnzìpǔ</span>
      ...
      <div class="card c-sienna">
        <div class="card-head">
          <span class="card-cn">泛音</span>
          <span class="card-py">fànyīn</span>
          <span class="card-en">harmonic tones — the "heavenly" register of the guqin</span>
        </div>
        <div class="card-def">
          泛 fàn (to float; to overflow) + 音 yīn (sound). Produced by lightly touching the string at one of the 13 marked 徽 huī positions without pressing it to the board, then plucking. The result is a clear, bell-like overtone. In guqin aesthetics, 泛音 is associated with heaven (天 tiān), in contrast to 散音 sǎnyīn (open strings, associated with earth 地 dì) and 按音 ànyīn (stopped strings, associated with humanity 人 rén).
        </div>
      </div>

      <div class="card c-red">
        <div class="card-head">
          <span class="card-cn">高山流水</span>
          <span class="card-py">gāoshān liúshuǐ</span>
      ...
      <div class="card c-neutral">
        <div class="card-head">
          <span class="card-cn">文人</span>
          <span class="card-py">wénrén</span>
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Guqin Idioms</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="adj-wrap">
      <span class="adj" data-relation="derived"><span class="a-cn">知音</span><span class="a-py">zhīyīn</span><span class="a-en">one who truly understands</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">伯牙</span><span class="a-py">Bó Yá</span><span class="a-en">the master qin player (Spring and Autumn period)</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">高山流水</span><span class="a-py">gāoshān liúshuǐ</span><span class="a-en">High Mountains, Flowing Water (the piece; the meeting)</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">琴棋书画</span><span class="a-py">qín qí shū huà</span><span class="a-en">the four scholarly arts</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">文人</span><span class="a-py">wénrén</span><span class="a-en">literati; the scholarly class</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">减字谱</span><span class="a-py">jiǎnzìpǔ</span><span class="a-en">guqin tablature notation</span></span>
      <span class="adj" data-relation="contrast" data-distinct="古筝 has more strings (21), uses bridges, and is associated with popular and folk performance; 古琴 is intimate, bridgeless, and literati-coded"><span class="a-cn">古筝</span><span class="a-py">gǔzhēng</span><span class="a-en">guzheng zither</span></span>
      <span class="adj" data-relation="contrast" data-distinct="二胡 is a bowed two-string fiddle associated with folk and regional music; 古琴 is plucked and literati-associated"><span class="a-cn">二胡</span><span class="a-py">èrhú</span><span class="a-en">erhu fiddle</span></span>
      <span class="adj"><span class="a-cn">乐器</span><span class="a-py">yuèqì</span><span class="a-en">musical instrument</span></span>
      <span class="adj"><span class="a-cn">音乐</span><span class="a-py">yīnyuè</span><span class="a-en">music</span></span>
      <span class="adj" data-relation="collocation" data-distinct="文房四宝 is the four treasures of the study (brush, ink, paper, inkstone) — a parallel literati canon to 琴棋书画"><span class="a-cn">文房四宝</span><span class="a-py">wénfángsìbǎo</span><span class="a-en">four treasures of the scholar's studio</span></span>
    </div>

    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>古琴 gǔqín</span> · topic_guqin.html</span>
