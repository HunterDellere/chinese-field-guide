...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <ul class="toc-list">
      <li><a href="#scripts">
        <span class="toc-cn">字体</span> The Five Scripts
        <span class="toc-sub">zìtǐ · seal to cursive</span>
      </a></li>
      <li><a href="#tools">
        <span class="toc-cn">文房四宝</span> Four Treasures
        <span class="toc-sub">wénfáng sìbǎo · brush, ink, stone, paper</span>
      </a></li>
      <li><a href="#wangxizhi">
        <span class="toc-cn">王羲之</span> Wang Xizhi
        <span class="toc-sub">wáng xīzhī · the Sage of Calligraphy</span>
      </a></li>
      <li><a href="#aesthetic">
        <span class="toc-cn">美学</span> The Aesthetic
        <span class="toc-sub">měixué · brush quality and inner state</span>
      </a></li>
      <li><a href="#vocab">
  ...
  <main class="main">
    ...
    <header class="topic-hero">
      ...
      <span class="topic-hero-title-py">shūfǎ</span>
    ...
    <section class="section-anchor" id="scripts">
      ...
      <div class="scholar" data-glyph="書">
        ...
        <p>Chinese calligraphy recognizes five canonical script styles, each with its own history, aesthetic, and expressive register:</p>
    ...
    <section class="section-anchor" id="vocab">
      ...
      <div class="cards">
        <div class="card c-ochre">
          <div class="card-head"><span class="tag-n">n</span> 笔画 bǐhuà</div>
          <p>Stroke — the individual marks that compose a character. The number and order of strokes is standardized; writing them in the wrong order affects both legibility and aesthetic quality.</p>
        </div>
        <div class="card c-ochre">
          <div class="card-head"><span class="tag-n">n</span> 临摹 línmó</div>
          <p>Copying from a model — the primary method of calligraphic training. Students copy masterworks for years before attempting original work.</p>
        </div>
        <div class="card c-teal">
