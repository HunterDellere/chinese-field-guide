...
export function buildPageFooter(body, fm, slug, category) {
  ...
  const newFooter = `<footer class="page-footer">
      <div class="page-footer-colophon">
        <span class="page-footer-seal" aria-hidden="true">書屋</span>
        <p class="page-footer-epigraph">Every character is a door. Thanks for walking through one.</p>
      </div>
      <div class="page-footer-meta">
        ...
        <div class="pf-cell pf-cell-cta">
          <div class="label">Support</div>
          <a class="pf-btn pf-btn-donate" href="https://ko-fi.com/hdellere" target="_blank" rel="noopener" aria-label="Donate — buy me a tea">
            <span class="pf-btn-cn" aria-hidden="true">茶</span>
            <span class="pf-btn-text">Donate to buy me a <span class="pf-btn-cn-inline">茶</span></span>
          </a>
        </div>
        <div class="pf-cell pf-cell-cta">
          ...
          <button type="button" class="pf-btn pf-btn-share" data-share aria-label="Share this page">
            ...
            <span class="pf-btn-text" data-share-label>Share this entry</span>
          </button>
        </div>
      </div>
